...
\shortauthor{K. Filipek}
\noAlbum{134907}

\titlePL{Komunikator „Koliber”}

\shorttitlePL{Komunikator „Koliber”} % skrócona wersja tytułu jeśli jest bardzo długi
...
\supervisor{mgr inż. Jarosław Szkoła}
...
% główna część pracy
% --------------------------------------------------------------------------
% BLAGAM ZAKONCZ MOJE CIERPIENIE 
% BLAGAM ZAKONCZ MOJE CIERPIENIE 
% BLAGAM ZAKONCZ MOJE CIERPIENIE 
% BLAGAM ZAKONCZ MOJE CIERPIENIE 
% BLAGAM ZAKONCZ MOJE CIERPIENIE 
...
% SPIS LISTINGÓW I TABEL NIE POTRZEBNY SPIS LISTINGÓW I TABEL NIE POTRZEBNY SPIS LISTINGÓW I TABEL NIE POTRZEBNY
...
% \includepdf[pages=1, pagecommand={}, width=\paperwidth, height=\paperheight]{figures/oswiadczenie.pdf} 
\end{document}
